(function (global) {
  ...
  var messages = {
    "zh-CN": {
      ...
      "attribution.status": "本站为非官方、免费、严格非商业工具，不暗示 Quareia 或作者为项目背书。Mystagogus 与 LXXXI 魔法牌的牌面及相关文本经作者书面许可，覆盖本免费网站与未来免费、开源的 Android 应用，但仅限严格非商业使用，并排除在一切开源许可之外。",
    ...
    "en": {
      ...
      "attribution.status": "This is an unofficial, free, strictly non-commercial tool. It does not imply any endorsement by Quareia or the authors. Written permission covers this free website and a future free, open-source Android application, provided that the Mystagogus and LXXXI artwork and related text remain strictly non-commercial and are excluded from all open-source licences.",
