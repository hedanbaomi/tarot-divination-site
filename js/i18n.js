(function (global) {
  ...
  var messages = {
    "zh-CN": {
      ...
      "spread.reveal": "开牌解读",
      "spread.clear": "重新洗牌",
      "spread.hint": "轻点任意一张牌可单独翻开，或按「开牌解读」全部翻开。",
      "spread.guide": "查看牌位说明",
      ...
      "spread.origin.tarot": "出自塔罗牌",
      "spread.origin.mystagogus": "出自 M 牌",
      "spread.origin.lxxxi": "出自 LXXXI 牌",
      ...
      "app.spreadComplete": "{spread} · {origin} 已完成，可以开牌解读",
      ...
      "app.revealedAria": "位置 {number} · {position}{layer} · {card} · {orientation}",
    ...
    "en": {
      ...
      "spread.hint": "Tap a card to reveal it, or choose “Reveal & Interpret” to turn over every card.",
      ...
      "spread.origin.tarot": "Tarot spread",
      "spread.origin.mystagogus": "Mystagogus spread",
      "spread.origin.lxxxi": "LXXXI spread",
      ...
      "app.spreadComplete": "{spread} · {origin} complete. You can now reveal the reading.",
      ...
      "app.revealedAria": "Position {number} · {position}{layer} · {card} · {orientation}",
