(function (global) {
  ...
  var messages = {
    "zh-CN": {
      ...
      "attribution.status": "本站为非官方、免费、严格非商业工具，不暗示 Quareia 或作者为项目背书。Mystagogus 与 LXXXI 魔法牌的牌面及相关文本经作者书面许可，仅限本项目严格非商业使用，不在 MIT 许可范围内。",
    ...
    "en": {
      ...
      "attribution.status": "This is an unofficial, free, strictly non-commercial tool. It does not imply any endorsement by Quareia or the authors. The Mystagogus and LXXXI artwork and related text are used with the author's written permission, strictly non-commercial and for this project only, and are excluded from the MIT License.",
